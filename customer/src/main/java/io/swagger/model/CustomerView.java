...
@MaterializedView(baseEntity = Customer.class, view = "Customer_view")
public class CustomerView {
	...
	@Column("account_status")
	  ...
	  public CustomerView firstName(String firstName) {
	  ...
	  **/
	  ...
	  public CustomerView lastName(String lastName) {
	...
	public CustomerView primaryContactNumber(String primaryContactNumber) {
	  ...
	  **/
	  ...
	  public CustomerView address(Address address) {
	  ...
	  **/
	  ...
	  public CustomerView accountStatus(String accountStatus) {
	  ...
	  **/
	  ...
	  public CustomerView creditClass(String creditClass) {
	  ...
	  **/
	  ...
	  public CustomerView approvedLines(String approvedLines) {
	  ...
	  **/
	  ...
	  public CustomerView plan(String plan) {
	    this.plan = plan;
	    return this;
	  }
	...
	public String toString() {
		return "CustomerView [Customer_id=" + customer_id + ", faid=" + faid + ", firstName=" + firstName
				+ ", lastName=" + lastName + ", primaryContactNumber=" + primaryContactNumber + ", address=" + address
				+ ", accountStatus=" + accountStatus + ", creditClass=" + creditClass + ", approvedLines="
				+ approvedLines + ", plan=" + plan + "]";
	}
