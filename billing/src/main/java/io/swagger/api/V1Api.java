...
public interface V1Api {
    ...
    @ApiOperation(value = "Get unifier information", notes = "This API will return billing and customer information.", response = Billing.class, tags={ "unifier", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "The request was successful", response = Billing.class),
    ...
    @RequestMapping(value = "/v1/customer/{customer_id}/billing",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Billing> unifier(@ApiParam(value = "customer id",required=true ) @PathVariable("customer_id") String customerId,@ApiParam(value = "authorization header" ) @RequestHeader(value="authorization", required=false) String authorization,@ApiParam(value = "application user id" ) @RequestHeader(value="applicationId", required=false) String applicationId);
